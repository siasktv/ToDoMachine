...
function ToDoForm() {
  ...
  const onCancel = () => {
    // Función que cierra el formulario para ingresar nuevo ToDO al cambiar el State a false del 'setOpenModal'
    setOpenModal(false)
  }

  const onChange = (event) => {
    // Validamos cada vez que se escribe en el TextArea
