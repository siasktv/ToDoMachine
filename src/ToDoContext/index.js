...
import { useLocalStorage } from './useLocalStorage' // Importamos el Hook 'useLocalStorage' que creamos para manejar los datos de LocalStorage
...
function ToDoProvider({ children }) {
  // Importamos los props, en esta caso es el Componente 'AppUI'
  const {
  ...
  return (
    <ToDoContext.Provider
      value={
        // Retornamos todos los States y props que se usaran en el proyecto
        {
          loading,
          error,
          completedToDos,
